...
function initDB(m, client) {
  ...
  settings.id ??= '120363426049825967@newsletter'
  settings.nameid ??= "♥️*♡∞:｡.｡𝕱𝖗𝖆𝖘𝖊𝖘 𝖉𝖊𝖑  𝖈𝖔𝖗𝖆𝖟𝖔𝖓 ｡.｡:∞♡*♥️"
  settings.type ??= 'Owner'
  settings.link ??= 'https://wa.me/51963896243'
  settings.banner ??= 'https://i.postimg.cc/q7vKvdTj/SAVE-20260205-191658.jpg'
  settings.icon ??= 'https://i.postimg.cc/q7vKvdTj/SAVE-20260205-191658.jpg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'GRIS'
  settings.botname ??= 'GRIS MICAELA'  
  settings.owner ??= ''
